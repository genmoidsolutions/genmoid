    ...
    <section id="internships" className="py-20 px-4 bg-black/20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">Join our comprehensive internship program and kickstart your career</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {internships.map((internship) => (
            <div key={internship.id} className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-2xl p-6 border border-gray-700/50 hover:border-purple-500/50 transition-all">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-400">{internship.openings} openings</span>
              </div>

              <h3 className="text-xl font-semibold text-white mb-3">{internship.title}</h3>
